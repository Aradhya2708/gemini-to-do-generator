...
import { FaHome, FaTasks, FaCog, FaSync } from 'react-icons/fa';
import axios from 'axios';

import NavButton from './NavButton'; // Import the NavButton component

// import { FaArrowLeft, FaEllipsisV, FaSignOutAlt, FaCog } from "react-icons/fa";
...
const NavBar = () => {
	...
	const handleFetchEmails = async () => {
		try {
			const response = await axios.get('//localhost:5000/emails/fetch', {withCredentials: true});
	...
	return (
		<div className="fixed top-0 left-0 w-full h-16 mb-10 flex items-center justify-between p-4 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
			...
			<h1 className="text-4xl font-bold flex justify-center text-gray-100">
				To Do Manager
			</h1>
